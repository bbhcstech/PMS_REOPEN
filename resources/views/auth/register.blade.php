...
<head>
  ...
  <title>Create account - Bitroxia</title>
    ...
    * {
    ...
    body {
      ...
      background:
        ...
        radial-gradient(circle at 88% 16%, rgba(143, 37, 255, 0.18), transparent 28%),
    ...
    .auth-shell {
      ...
      border-radius: 34px;
      background:
        linear-gradient(160deg, rgba(255, 255, 255, 0.95) 0%, rgba(246, 250, 255, 0.92) 54%, rgba(255, 247, 207, 0.9) 100%);
    ...
    .task-card {
      ...
      width: 184px;
      padding: 14px 16px;
      background: linear-gradient(135deg, #fff176, #ffd04d);
      color: #1f2435;
      font-size: 0.78rem;
      font-weight: 700;
  ...
  <main class="auth-shell">
    <section class="auth-form-panel">
      ...
      <div class="form-wrap">
        ...
        <p class="auth-subtitle">Sign up and get your workspace ready</p>
        ...
        <form id="formAuthentication" method="POST" action="{{ route('register') }}" class="auth-form">
          ...
          <div class="form-group">
            ...
            <div class="input-wrapper">
              ...
              <input type="email" name="email" class="form-control" id="email" value="{{ old('email') }}" required autocomplete="username" placeholder="you@company.com">
            </div>
          ...
          <div class="form-group password-group">
            ...
            <div class="input-wrapper">
              ...
              <input type="password" name="password" class="form-control" id="yourPassword" placeholder="9+ characters" required autocomplete="new-password">
      ...
      <div class="auth-footer">
        <span>Have an account? <a href="{{ route('login') }}">Sign in</a></span>
        <a href="javascript:void(0);">Terms &amp; Conditions</a>
      </div>
    </section>

    <section class="visual-panel">
      <a href="{{ route('login') }}" class="close-link" aria-label="Back to login">
        <i class="bx bx-x"></i>
      </a>
