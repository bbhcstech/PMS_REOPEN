...
<div class="sub-department-form-page">
    <!-- Breadcrumb -->
    <div class="breadcrumb">
        <i class="fas fa-pen"></i> Dashboard / Sub Departments / Edit
    </div>
    ...
    <div class="header-card">
        <div class="header-left">
            ...
            <div>
                ...
                <p>Update the department name and reporting structure</p>
            </div>
        </div>
        <div class="btn-group">
    ...
    <!-- Form Card -->
    <div class="form-card">
        <form method="POST" action="{{ route('departments.update', $department->id) }}" class="form-content">
            @csrf
            @method('PUT')
            ...
            <div class="form-field">
                ...
                <div class="field-content">
                    ...
                    <input type="text"
                           ...
                           value="{{ old('dpt_code', $department->dpt_code) }}"
                           required
            ...
            <div class="form-field">
                ...
                <div class="field-content">
                    ...
                    <input type="text"
                           ...
                           value="{{ old('dpt_name', $department->dpt_name) }}"
                           required
                ...
                <div class="field-content">
                    ...
                    <select name="parent_dpt_id" id="parent_dpt_id" class="form-select @error('parent_dpt_id') is-invalid @enderror" required>
                        ...
                        @foreach($parentDepartments as $pd)
                            <option value="{{ $pd->id }}"
                                {{ (int) old('parent_dpt_id', $department->parent_dpt_id) === (int) $pd->id ? 'selected' : '' }}>
                                {{ $pd->dpt_name }}
                            </option>
                        @endforeach
                    </select>
...
<style>
    ...
    html[data-pms-theme="dark"] .btn-primary {
        background: linear-gradient(145deg, #fbbf24, #f59e0b);
    }
</style>
